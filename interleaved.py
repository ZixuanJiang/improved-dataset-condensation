...
def main():
    ...
    parser.add_argument('--file_name_prefix', type=str, default='interleaved', help='the prefix name of the generated file (png file and pt file)')
    ...
    channel, im_size, num_classes, class_names, mean, std, dst_train, dst_test, trainloader_real, testloader = get_dataset(args.dataset, args.data_path, args.batch_real * 4)
